...
<script type="text/javascript" src="{{site.mathjax_prefix}}/MathJax.js?config=TeX-AMS-MML_HTMLorMML">
</script>
{% endhighlight %}

大家也可以看此博文[BM25]({{ site.url }}{% post_url CHINESE/2014-08-19-bm25 %})预览MathJax效果。
...
可以参见我另一篇博文 [Jekyll 页面加载优化]({{ site.url }}{% post_url CHINESE/2015-04-14-jekyll-html-minimization %})
