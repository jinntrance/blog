//have a look at https://github.com/beiyuu/blog/blob/gh-pages/js/post.js    
  var isMobile = {
        Android: function() {
    ...
    (function(){
        ...
        if($('.entry h2').length > 2 && !isMobile.any()){
            ...
            $(window).load(function(){
                ...
                var menuIndexTop = $('#menuIndex').position().top;
                var menuIndexLeft = $('#menuIndex').position().left;
